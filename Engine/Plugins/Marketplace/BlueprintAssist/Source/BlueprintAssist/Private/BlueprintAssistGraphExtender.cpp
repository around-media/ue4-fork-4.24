...
bool FBAGraphExtender::GenerateGetter(const UEdGraph* Graph, const UEdGraphNode* Node)
{
	...
	const FString FunctionName = FString::Printf(TEXT("Get%s"), *SourceVariableGet->VariableReference.GetMemberName().ToString());
...
bool FBAGraphExtender::GenerateSetter(const UEdGraph* Graph, const UEdGraphNode* Node)
{
	...
	const FString FunctionName = FString::Printf(TEXT("Set%s"), *SourceVariableGet->VariableReference.GetMemberName().ToString());
