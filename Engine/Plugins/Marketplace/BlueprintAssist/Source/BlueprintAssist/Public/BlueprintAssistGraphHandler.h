...
public:
	...
	bool TryAutoFormatNode(UEdGraphNode* Node, TSharedPtr<FScopedTransaction> PendingTransaction = TSharedPtr<FScopedTransaction>());
...
private:
	...
	void SaveNodesSizes(const TArray<UEdGraphNode*>& Nodes);
	...
	void SetDefaultSizeForFocusedNode();
